...
public class KLineGridAxisDrawing implements IDrawing {
    ...
    //+++++++++++++++++++++++++++
    public KLineGridAxisDrawing() {

    }

    public KLineGridAxisDrawing(int digits, int intDigit) {
        this.digits = digits;
...
//        contentRect.bottom = contentRect.bottom+40;
        //+++++++++++++++++++++++++
    ...
    public void onComputeOver(Canvas canvas, int minIndex, int maxIndex, float minY, float maxY) {
        ...
        final int count = render.getZoomTimes() < 0 ? Math.abs(7 * render.getZoomTimes()) + 2 : 9;//+++++++++++++7--->9 目的：降低网格竖线的密度
    ...
    public void onDrawOver(Canvas canvas) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            canvas.drawText(value, labelX + 100, pointCache[0], yLabelPaint);//++++++++++++++++++++++++++  +100
        }
    }
}
