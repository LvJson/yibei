...
public class InteractiveKLineLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void initUI(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        macdHighlightDrawing.addMarkerView(new YAxisTextMarkerView(stockMarkerViewHeight,2));
        ...
        rsiHighlightDrawing.addMarkerView(new YAxisTextMarkerView(stockMarkerViewHeight,2));
        ...
        kdjHighlightDrawing.addMarkerView(new YAxisTextMarkerView(stockMarkerViewHeight,2));
        ...
        bollHighlightDrawing.addMarkerView(new YAxisTextMarkerView(stockMarkerViewHeight,2));
