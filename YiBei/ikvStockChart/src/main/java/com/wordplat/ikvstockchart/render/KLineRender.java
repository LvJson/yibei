...
import com.wordplat.ikvstockchart.drawing.CurrentTimeDrawing;
...
public class KLineRender extends AbstractRender {
    ...
    public KLineRender(Context context, int digits,int intDigit) {
        this.context = context;

        kLineDrawingList.add(new KLineGridAxisDrawing(digits,intDigit));
        kLineDrawingList.add(candleDrawing);
        kLineDrawingList.add(maDrawing);
        kLineDrawingList.add(emptyDataDrawing);
        kLineDrawingList.add(new CurrentTimeDrawing(digits));//+++++++++++++++++
