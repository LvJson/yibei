...
public class HighlightDrawing implements IDrawing {
    ...
    public void onDrawOver(Canvas canvas) {
        ...
        if (render.isHighlight()) {
            ...
            render.getEntrySet().getEntryList().size();
            canvas.drawLine(highlightPoint[0], contentRect.top, highlightPoint[0], contentRect.bottom, highlightPaint);//画竖线
            canvas.drawLine(contentRect.left, highlightPoint[1], contentRect.right - 120, highlightPoint[1], highlightPaint);//画横线++++++++++++++++++  -120
