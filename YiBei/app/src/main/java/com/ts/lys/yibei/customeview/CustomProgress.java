...
public class CustomProgress extends Dialog {
    ...
    public static CustomProgress show(Context context) {
        return CustomProgress.show(context, null, true, null);
    }

    public static CustomProgress show(Context context, boolean cancelable) {
        return CustomProgress.show(context, null, cancelable, null);
    }

//    public static ProgressBarCircularIndeterminate showMDProgress(Context context) {
//        ProgressBarCircularIndeterminate dialog = new ProgressBarCircularIndeterminate(context, null);
